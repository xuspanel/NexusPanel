...
```html
<link rel="stylesheet" href="/css/style.css?v=1.35.1">
<script defer src="/js/dashboard.js?v=1.35.1"></script>
```
...
- Use conventional messages: `v1.35.1: Add Git Deploy with webhook auto-deploy`
